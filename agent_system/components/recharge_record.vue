<template>
	<view class="board">
		<view class="box">
			...
			<searchBox :showRange="true" :timeStr="timeStr" :showRechargeStatus="true" @handleSearch="handleSearch">
			</searchBox>
	...
	export default {
		...
		methods: {
			...
			getList() {
				...
				let url = "/broker/company-recharges?page=" + this.currentPage + "&page_size=" + this.currentCount +

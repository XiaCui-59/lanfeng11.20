			...
			<view class="base_info flex flex_btween">
				...
				<view class="line flex flex-start">
					...
					<view class="line_text flex flex-start">
						<text
							style="font-size: 30px;color:#FAAD14;font-weight: 600;font-family: 'Times New Roman', Times, serif;">&yen;{{accountInfo.amount}}</text>

	...
	<view class="vip">
		...
		<view class="" v-else>
			...
			<view class="cont" :style="{marginTop:marginTop+tabMargin+'px'}">
				<view class="top">
					<view class="info"
						:style="{backgroundImage:userInfo.is_vip?`url(${imgUrl}/worker/vip_bg.png)`:`url(${imgUrl}/worker/not_vip_bg.png)`}">
						<image class="tit"
							:src="userInfo.is_vip?imgUrl+'/worker/vip_title2.png':imgUrl+'/worker/new/not_vip_title.png'"
							mode="widthFix"></image>
				...
				<view class="more">
					...
					<view class="text">
						<view class="line">特权一：会员可预定工作，享优先选择权和推荐。</view>
						<view class="line">特权二：优先匹配，快速响应，高效对接优质岗位。</view>
						<view class="line">特权三：提供工作分析，助力会员做出职业决策。</view>
						<view class="line">特权四：提供行业分析，帮助会员完善职业规划。</view>
					</view>
				</view>
			</view>
		...
		.cont {
			...
			.top {
				...
				.info {
					...
					padding: 28rpx 40rpx 40rpx 60rpx;
					background-repeat: no-repeat;

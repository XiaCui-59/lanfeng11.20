...
/***/ 160:
/*!**********************************************************************************************!*\
  !*** E:/项目文件/langeng5.11/release/employee_onlychat/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \**********************************************************************************************/
...
/***/ 161:
/*!***************************************************************************!*\
  !*** E:/项目文件/langeng5.11/release/employee_onlychat/pages/index/index.vue ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ 162:
/*!**********************************************************************************************************!*\
  !*** E:/项目文件/langeng5.11/release/employee_onlychat/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \**********************************************************************************************************/
...
try {
  components = {
    uNavbar: function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-navbar/u-navbar */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-navbar/u-navbar")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-navbar/u-navbar.vue */ 232))
    },
    uPopup: function () {
...
var render = function () {
  ...
  var l0 = !_vm.ifSingle
    ? _vm.__map(_vm.historyList, function (item, index) {
        ...
        var g2 = item.msg_type == "voice" ? Math.ceil(item.voice.second) : null
        return {
          $orig: $orig,
          g0: g0,
          g1: g1,
  ...
  var l1 = !_vm.ifSingle
    ? _vm.__map(_vm.qaList, function (item, index) {
        ...
        var g4 =
          item.msg_type == "voice" ? Math.ceil(item.voice.second * 20) : null
        var g5 = item.msg_type == "voice" ? Math.ceil(item.voice.second) : null
        return {
          $orig: $orig,
          g3: g3,
          g4: g4,
...
/***/ 164:
/*!****************************************************************************************************!*\
  !*** E:/项目文件/langeng5.11/release/employee_onlychat/pages/index/index.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 165:
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/项目文件/langeng5.11/release/employee_onlychat/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var login = function login() {
  __webpack_require__.e(/*! require.ensure | components/login */ "components/login").then((function () {
    return resolve(__webpack_require__(/*! @/components/login.vue */ 264));
...
var _default = {
  ...
  methods: {
    ...
    sendBtnMsg: function sendBtnMsg(msg) {
      this.ques = msg;
      this.sendQuestion();
    },
    ...
    getInfo: function getInfo() {
      ...
      this.$request("/worker/profile").then(function (response) {
        if (response.code == 0) {
          ...
          _this4.menuList[0].value = response.data.balance;
        }
      });
    },
    ...
    paramsPost: function paramsPost(header) {
      this.$request("/ad/tracking", this.params, "POST", header).then(function (res) {
        if (res.code == 0) {
      ...
      if (this.currentPlayType == "his") {
        this.historyList.forEach(function (el, index) {
          if (el.msg_type == "voice") {
            if (index == _this5.currentPlayIndex) {
              _this5.historyList[_this5.currentPlayIndex].voice.anmitionPlay = true;
            } else {
        ...
        this.qaList.forEach(function (el, index) {
          if (el.msg_type == "voice") {
            if (index == _this5.currentPlayIndex) {
              _this5.qaList[_this5.currentPlayIndex].voice.anmitionPlay = true;
            } else {
              _this5.qaList[index].voice.anmitionPlay = false;
            }
          }
    ...
    closeAnmition: function closeAnmition() {
      ...
      if (this.currentPlayType == "his") {
        this.historyList.forEach(function (el, index) {
          if (el.msg_type == "voice") {
            if (el.id == id) {
              _this7.historyList[index].voice.anmitionPlay = false;
            }
          }
        });
        ...
        this.qaList.forEach(function (el, index) {
          if (el.msg_type == "voice") {
            if (el.id == id) {
              _this7.qaList[index].voice.anmitionPlay = false;
            }
          }
        });
        ...
        uni.login({
          success: function success(res) {
            ...
            if (res.errMsg == 'login:ok') {
              ...
              _this8.$request(url, data, "POST", _this.header).then(function (resp) {
                if (resp.code == 0) {
                  uni.setStorage({
                    key: "openid",
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 8;
                return _this9.getHistory();
              case 8:
                _this9.historyList = _context2.sent;
                _this9.toScroll();
                _this9.creatConnect();
                // this.initRecord()
              case 11:
      ...
      if (!this.loadAllHistory) {
        ...
        this.$request(url).then(function (res) {
          if (res.code == 0) {
            ...
            var newArr = _this10.handleList(resArr);
            _this10.historyList = newArr.concat(_this10.historyList);
            var len = res.data.length;
            if (len > 0) {
              _this10.historyId = res.data[0].id;
            } else {
              _this10.loadAllHistory = true;
            }
          }
        });
      } else {
...
/***/ 166:
/*!*************************************************************************************************************!*\
  !*** E:/项目文件/langeng5.11/release/employee_onlychat/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

<template>
	<view class="invite">
		...
		<view class="" v-else>
			<!-- 自定义导航 -->
			<u-navbar title="邀请有礼" @rightClick="rightClick" :autoBack="true" bgColor="transparent"
			...
			<view class="cont">
				...
				<view class="mask" v-show="showMask" @click="closeAll">
					<view class="inner method" v-show="showMethods" @click.stop="">
						...
						<view class="bot">
							<u-grid :border="false" customStyle="position: relative;top:-50%;">
								<u-grid-item v-for="(listItem,index) in shareList.slice(0,1)" :key="index">
									<button class="button" open-type="share">
										...
										font-size: 30rpx;
										color: #FFFFFF;margin-top:10rpx;">{{listItem.title}}</text>
									</button>
								</u-grid-item>

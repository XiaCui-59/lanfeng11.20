				...
				<view class="sub_box">
					...
					<view class="line">
						...
						<view class="input_wrap noborder" style="height:auto;width:95%;">
							<textarea v-model="collectInfo.content" placeholder="请输入详细需求" style="height:529px;"
								maxlength="1000" />
							<view class="word_len">{{collectInfo.content.length+"/1000"}}</view>
						</view>
					</view>
				...
				<view class="sub_box">
					<view class="line">
						...
						<view class="input_wrap">
							<input type="text" v-model="collectInfo.broker_name" disabled style="color: #999;" />
						</view>
					</view>
					<view class="line">
					...
					<view class="line">
						...
						<view class="input_wrap wrap" style="height:auto;" @click="openAddress">
...
<script>
	...
	export default {
		...
		methods: {
			...
			getInfo() {
				let url = "/admin/project/collection/" + this.id + "/info"
			...
			submit() {
				let _this = this
				let data = {
					"broker_id": this.collectInfo.broker_id,
					...
					"content": this.collectInfo.content,
			...
			// 		"price": this.fee
			// 	}
			// 	let url = "/admin/project/" + this.currentId + "/set-fee"

<template>
	<view class="board">
		<view class="box">
			...
			<searchBox :showBroker="true" :showRange="true" :timeStr="timeStr" :showRechargeStatus="true"
			...
			<view class="table_wrap">
				<uni-table border stripe emptyText="暂无更多数据">
					<uni-tr style="background: #f6f6f6;">
						...
						<uni-th align="center" style="font-size: 14px;font-weight: 600;color:#333;">充值编号</uni-th>
						...
						<uni-th align="center" style="font-size: 14px;font-weight: 600;color:#333;">充值金额（元）</uni-th>
						<uni-th align="center" style="font-size: 14px;font-weight: 600;color:#333;">充值方式</uni-th>
						<uni-th align="center" style="font-size: 14px;font-weight: 600;color:#333;">状态</uni-th>
						<uni-th align="center" style="font-size: 14px;font-weight: 600;color:#333;">充值描述</uni-th>
						<uni-th align="center" style="font-size: 14px;font-weight: 600;color:#333;">充值时间</uni-th>
						<uni-th align="center" style="font-size: 14px;font-weight: 600;color:#333;">到账时间</uni-th>
					</uni-tr>
					<uni-tr v-for="(item,index) in list">
						...
						<uni-td
							align="center">{{payMethods.filter(el => {return el.channel == item.channel})[0].text}}</uni-td>
						<uni-td
						...
						<uni-td align="center">{{item.recharge_time}}</uni-td>
					</uni-tr>
	...
	export default {
		...
		data() {
			return {
				...
				currentPage: 1,
				currentCount: 15,
				status: commonData.rechargeStatus,
				searStatus: "",
				searStart: "",
				searEnd: "",
				searBroker: "",
		...
		methods: {
			...
			getList() {
				...
				let url = "/admin/company-recharges?page=" + this.currentPage + "&page_size=" + this.currentCount +
					"&create_time_start=" + this.searStart + "&create_time_end=" + this.searEnd + "&status=" + this
					.searStatus + "&company_name=" + this.searBroker

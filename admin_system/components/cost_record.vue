<template>
	<view class="board">
		<view class="box">
			...
			<searchBox :showBroker="true" :showRange="true" :timeStr="timeStr" @handleSearch="handleSearch">
			</searchBox>
	...
	export default {
		...
		methods: {
			...
			getList() {
				...
				let url = "/admin/company/bill?page=" + this.currentPage +
					"&page_size=" + this.currentCount + "&create_time_start=" + this.searStart + "&create_time_end=" + this
					.searEnd + "&company_name=" + this.searBroker

	...
	<view class="htz-image-upload-list">
		...
		<view class="htz-image-upload-Item htz-image-upload-Item-add" v-if="uploadLists.length<max && add"
			...
			<view class="tips_wrap">
				<image :src="mediaType=='video'?imgUrl+'/broker/ic_video.png':imgUrl+'/broker/ic_image.png'"
					mode="widthFix"></image>
				<view>点击上传</view>
			</view>
...
<style>
	...
	.htz-image-upload-Item-add .tips_wrap {
		position: absolute;
		top: 50%;
		left: 50%;
	...
	.htz-image-upload-Item-add .tips_wrap image {
		width: 78rpx;
		height: 78rpx;
	}

	.htz-image-upload-Item-add .tips_wrap view {
		font-weight: 400;
		font-size: 23rpx;
		color: #9E9E9E;
		line-height: 33rpx;

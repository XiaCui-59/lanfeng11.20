<template>
	<view class="uni-table-scroll" :class="{ 'table--border': border, 'border-none': !noData }">
		<!-- #ifdef H5 -->
		<table class="uni-table" border="0" cellpadding="0" cellspacing="0" :class="{ 'table--stripe': stripe }" style="min-width: 1400rpx;">
			<slot></slot>
		...
		<!-- #endif -->
		<!-- #ifndef H5 -->
		<view class="uni-table" :class="{ 'table--stripe': stripe }"  style="min-width: 1400rpx;">
			<slot></slot>
